...
class Exp_BinaryOp {
    public:
        ...
        ReturnValue * interpret(bool isMethod, AST_MainClass * mainClass, MethodInvoke * methodInvoke);
        AST_Exp * optimizeImmediateValues();
};
class Exp_UnaryOp {
    public:
        char op;    //!, +, -
...
class AST_Statement {
    public:
        ...
        void optimizeImmediateValues();
};
class Program {
    public:
        AST_MainClass * MainClass;
        ClassDeclList * classDeclList;
        string name;                        //name of program from source file (program.java -> program)
        ...
        void resolveProgramName(char * name);
};
class AST_PrimeType {
    public:
        StoredType type;
