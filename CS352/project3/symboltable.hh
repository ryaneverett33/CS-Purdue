...
class ClassInfo {
    public:
        ...
        int classSize;
        int argCount;
        ClassInfo(bool mainClass, int classSize) {
            this->mainClass = mainClass;
            this->classSize = classSize;
        }
        ClassInfo(const ClassInfo& old) {
            this->mainClass = old.mainClass;
            this->classSize = old.classSize;
        }
        void printDebug();
};
class TableRow {
